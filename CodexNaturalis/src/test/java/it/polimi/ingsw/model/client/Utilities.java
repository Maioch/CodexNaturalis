...
public class Utilities {
    static void checkForUpdate(List<Pair<String, List<Object>>> recentCalls, String methodName, List<Object> args){
        Pair<String, List<Object>> call = recentCalls.getFirst();
        assertEquals(methodName, call.getKey());
        assertEquals(args, call.getValue());
    }

    static class TestSubmitter implements EventSubmitter {
        public void submit(Runnable runnable){
            runnable.run();
        }
    }

    static class TestView implements SetupView, GameView {
