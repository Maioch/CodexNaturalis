 ...
 */
public class DeprecatedTurnDeck extends DeprecatedDeck {
     ...
     */
    public DeprecatedTurnDeck(int range_start, int range_end, int numberOfVisibleCards){
    ...
    public boolean equals(Object object){
        if(this.getClass() != object.getClass())
            return false;
        DeprecatedTurnDeck other = (DeprecatedTurnDeck) object;
